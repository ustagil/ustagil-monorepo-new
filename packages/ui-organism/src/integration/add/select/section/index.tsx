...
import { Button, IntegrationAddSelectCard } from "@ustagil/ui-molecule";
...
export const IntegrationAddSelectSection: FC<IntegrationAddSelectSectionProps> =
  ({}) => {
    const { selectedApp, setSelectedApp } = useIntegrationEmailStore(
      (state) => ({
          ...
          {selectedApp && (
            <>
              ...
              <p className="">
                ...
                enim voluptates repudiandae consectetur voluptatem recusandae
                tenetur. Impedit quasi dolore atque error, earum esse. Vitae a
                praesentium quaerat illo, temporibus excepturi?
              </p>
              <p className="">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo
                enim voluptates repudiandae consectetur voluptatem recusandae
