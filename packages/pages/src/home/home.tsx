import { Button, Quote } from "@ustagil/design-system";
import { matchingTextColor, randomColor } from "@ustagil/utils";
...
export default function Home() {
  ...
  return (
    <Page>
      ...
      <Text variant="h2" className="mt-10 mb-6">
        packages/ustagil-design-system
      </Text>
      <Text className="mb-4">
      ...
      <Text variant="h2" className="mt-10 mb-6">
        packages/ustagil-pages
      </Text>
      <Text className="mb-4">
        Works in the same way as <Code>packages/ustagil-design-system</Code> but
      ...
      <Text className="mb-4">
        ...
        <Code>packages/ustagil-pages/src/home</Code> and imported by{" "}
        <Code>apps/main/pages/index.tsx</Code>.
      </Text>
      <Text variant="h2" className="mt-10 mb-6">
        packages/ustagil-utils
      </Text>
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/ustagil-storybook
      </Text>
      <Text className="mb-4">
        This packages takes the stories in{" "}
        <Code>packages/ustagil-design-system</Code> and opens them in{" "}
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/eslint-config-ustagil
      </Text>
      <Text className="mb-4">
